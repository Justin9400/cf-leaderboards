    ...
    <html>
      ...
      <div style={styles.card as React.CSSProperties}>
          <div style={styles.cardgrid as React.CSSProperties}>
            ...
            <div style={styles.cardtype as React.CSSProperties}><b>Creature - Senior UX Engineer</b></div>
            <div style={styles.series as React.CSSProperties}> </div>
            <div style={styles.desc as React.CSSProperties}>
            <p>
    <i>UX Revelation:</i> Once per user interaction, you may analyze a user flow or interface element. If you do, enhance the user experience, and your product gains a +2 user satisfaction rating.
  </p>
            </div>
